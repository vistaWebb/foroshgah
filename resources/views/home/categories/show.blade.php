              ...
              <div class="sidebar-widget">
                ...
                <div class="sidebar-widget-list mt-30">
                  <ul>
                    ...
                    @php
                        $childCategorys =  App\models\Category::Where( 'parent_id' , $category->parent->id )->get();

                    @endphp
                    @foreach ($childCategorys as $childCategory)
                      <li>
                        <a href="{{ route('home.categories.show' , ['category'=>$childCategory->slug ]) }}"
                          style="{{ $childCategory->name == $category->name ? 'color:#ff3535' : '' }}">                        {{$childCategory->name}}
                        </a>
                      </li>
                    @endforeach
                  </ul>
           ...
           <div class="col-md-7 col-sm-12 col-xs-12" style="direction: rtl;">
             <div class="product-details-content quickview-content">
               ...
               <div class="cart-plus-minus">
                   <input class="cart-plus-minus-box quantity-input" type="text" name="qtybutton" value="1"  date-max="5"  />
               </div>
