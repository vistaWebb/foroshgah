                ...
                <tbody>
                    @foreach ($transactions as $key=>$transaction)
                        <tr>
                            ...
                            <th>
                                <a class="btn btn-sm btn-outline-success" href="{{ route('Admin.transactions.show', ['transaction' => $transaction->id])  }}"> نمایش </a>
                                <a class="btn btn-sm btn-outline-info mr-3" href="{{ route('Admin.transactions.edit', ['transaction' => $transaction->id])  }}"> ویرایش </a>
                            </th>
